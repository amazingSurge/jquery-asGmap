...
(function(global, factory) {
      ...
      [
        {
          ...
          value: function loadScript() {
            ...
            script.src =
              ...
              '//maps.googleapis.com/maps/api/js?callback=asGmapOnScriptLoaded' +
              key;
        ...
        },
        {
          ...
          value: function init() {
            ...
            if (options.controlspositions.pan) {
              mapOptions.panControlOptions.position =
                options.controlspositions.pan;
            }
            ...
            if (options.controlspositions.scale) {
              mapOptions.scaleControlOptions.position =
                options.controlspositions.scale;
            }
            ...
            if (options.controlspositions.zoom) {
              mapOptions.zoomControlOptions.position =
                options.controlspositions.zoom;
            }
            if (options.styles) {
  ...
  window.asGmapOnScriptLoaded = function() {
    ...
    try {
      for (
        var _iterator = instances[Symbol.iterator](), _step;
